...
import { trackClickWishlistTriggerApp } from "lib/google-analytics/events";
...
export default function SledgeProductCard({
  ...
  return (
    ...
    >
      <div>
        <Trigger
          onAfterAddWishlist={() => trackClickWishlistTriggerApp("add")}
          onAfterRemoveWishlist={() => trackClickWishlistTriggerApp("remove")}
          params={{
            productId: id,
